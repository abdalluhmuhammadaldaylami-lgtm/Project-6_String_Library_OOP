...

{
    ...
    cout << "Number of words: " <<
        clsString::CountWords("Abdalluh Saqer Abdalluh") << endl;
    ...
    cout << "Capital Letters count : "
        << clsString::CountLetters("Mohammed Abdalluh", clsString::CapitalLetters)
        << endl << endl;
    ...
    //Tirms
    String3.Value = "    Mohammed Abdalluh     ";
    ...
    String3.Value = "Abdalluh Saqer Abu-Hahdoud";
    cout << "\n\nString     = " << String3.Value;
    ...
    String3.Value = "Mohammed Saqer Abdalluh";
